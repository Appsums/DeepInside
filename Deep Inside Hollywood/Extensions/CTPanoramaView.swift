...
@objc public class CTPanoramaView: UIView {
    ...
    private func createGeometryNode() {
        ...
        let customScene = SCNScene(named: "art.scnassets/ship.scn")!
...
//            vec = cameraNode.orientation
//          print(cameraNode.orientation.x)
...
//                                                panoramaView.cameraNode.orientation = motionData.orientation()
                                                ...
                                                panoramaView.cameraNode.orientation = SCNVector4Make((self?.norm(v:c.x + diff.x))!, (self?.norm(v:c.y + diff.y))!, (self?.norm(v:c.z + diff.z))!, c.w)
